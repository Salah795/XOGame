 ...
 * the ttt.player.WhateverPlayer strategy is to choose the coordinates randomly and tries to put his mark
...
public class WhateverPlayer implements Player {
    ...
    /**
     * The default constructor for the ttt.player.WhateverPlayer class
    ...
    /**
     * This method override from the Player interface it implements the ttt.player.WhateverPlayer strategy.
     * The strategy: is to choose the coordinates randomly and tries to put his mark
     * in the game board in these coordinates, and if it didn't succeed it will try again with different
     * coordinates that it will also choose randomly.
     * @param board The current state of the game board.
     * @param mark The mark of the ttt.player.WhateverPlayer.
     */
    @Override
