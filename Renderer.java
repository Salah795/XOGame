 ...
 * the types of the renderer (VoidRenderer, ConsoleRenderer).
 * It's having one method renderBoard() that should be implemented in all the renderer types
 * class. it receives the game board of type Board and implements the renderer type.
 *
...
interface Renderer {
     ...
     * It receives the game board of type Board and implements the renderer type.
